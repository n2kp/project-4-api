[User, Project, Tender].each do |model|
 ...
 User.create!(username: "jamesc",  firstname:"James", lastname:"Clarke", email: "james@justo.com", password: "password",password_confirmation: "password", image:"https://cms-assets.tutsplus.com/uploads/users/30/posts/22683/preview_image/prev.png", is_dev:false)
